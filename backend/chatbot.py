...
FIXED_FAQ_DATABASE = {
    "시간외근무는 어떻게 신청하나요?": "[인사근태(확장)] → [시간외근무] → [시간외근무 신청관리] 메뉴에서 신청 가능합니다. 1일 최대 3시간 30분, 월 최대 15시간까지 신청 가능하며, 휴게시간 30분을 제외해 입력해야 합니다.",
    "가족수당은 어떻게 신청하나요?": "급여 담당자 이메일로 가족수당 신청서와 증빙서류(가족관계증명서, 건강보험 자격확인서 등)를 제출하면 됩니다. 배우자 4만원, 직계존속·비속 각 3만원이 지급됩니다.※ 관련근거: 보수규정 시행규칙 별표 제1호",
    "복지포인트는 얼마나 부여되나요?": "정규직·계약직 직원에게 연간 1,000,000포인트(1P=1원)가 부여되며, 단체보험료 공제 후 잔액 한도 내에서 사용 가능합니다. 입·퇴사자는 근무기간에 따라 월할 계산 적용됩니다.",
    "출장신청 및 여비정산은 어떻게 하나요?": "출장신청은 [인사근태(확장)] → [근태신청서] → [출장신청] 메뉴에서 가능합니다. 국내출장은 1주일 이내, 국외출장은 2주일 이내에 운임·숙박비 등 증빙서류를 첨부하여 정산해야 합니다.",
    "전산장비(PC, 프린터 등)나 시설물 고장 시 어디에 문의하나요?": "전산기기 및 사무기기(PC, 복합기, 세단기 등)는 기기 중간 또는 하단에 부착된 수리기사 연락처로 직접 유선 문의하시면 됩니다. 기타 시설물(조명, 의자, 문손잡이 등) 고장은 경영지원부 물품관리 담당자에게 연락해 주시기 바랍니다"
}
# --- 2. 경로 및 모델 설정 ---
